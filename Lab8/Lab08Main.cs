...
namespace ASD
{
    class ElectionCampaignTestCase : TestCase
    {
        ...
        protected override (Result resultCode, string message) VerifyTestCase(object settings)
        {
            ...
            if (!_cities.IsEqual(_citiesClone))
        ...
        private (Result resultCode, string message)? VerifyValidVertex(int vertex, int index)
        {
            ...
            if (vertex >= _cities.VerticesCount)
    ...
    class ElectionCampaignTester : TestModule
    {
        ...
        public override void PrepareTestSets()
        {
            ...
            {
                var cities = new AdjacencyMatrixGraph(false, 4);
            ...
            {
                var cities = new AdjacencyMatrixGraph(false, 1);
            ...
            {
                var cities = new AdjacencyListsGraph<SimpleAdjacencyList>(false, 3);
...

            {
                ...
                var N = 25;
                var cities = rgg.TreeGraph(typeof(AdjacencyListsGraph<HashTableAdjacencyList>), N, 0.7, 1, 3, true);
                ...
                freeMeetingsTestCases.Add(new ElectionCampaignTestCase(TIME_MULTIPLIER, null, description, cities,
                    populations, meetingCosts: new double[N], budget: 40, capitalCity: 0, bestCampaignPeopleMet: 5831, bestCampaignCost: 4));
                meetingsWithCostsTestCases.Add(new ElectionCampaignTestCase(TIME_MULTIPLIER, null, description, cities,
...

            {
                ...
                var N = 50;
                var cities = rgg.UndirectedGraph(typeof(AdjacencyMatrixGraph), N, 0.8, 2, 5, true);
                var meetingCosts = new double[N];
                var populations = new int[N];
                populations[0] = 5000;
                meetingCosts[0] = 1;
...

            {
                ...
                var cities = new AdjacencyListsGraph<HashTableAdjacencyList>(false, 5);
...

            {
                ...
                var cities = new AdjacencyMatrixGraph(false, 5);
                cities.AddEdge(0, 1, 5);
                cities.AddEdge(0, 2, 5);
                cities.AddEdge(1, 2, 5);
...

            {
                ...
                var N = 20;
                var cities = rgg.UndirectedGraph(typeof(AdjacencyMatrixGraph), N, 0.7, 1, 20, true);
                var meetingCosts = new double[N];
                var populations = new int[N];
                for (int i = 0; i < populations.Length; i++)
                {
            ...
            #region Performance tests
            {
                ...
                var N = 25;
                var cities = rgg.UndirectedGraph(typeof(AdjacencyMatrixGraph), N, 0.9, 1, 20, true);
                var meetingCosts = new double[N];
                var populations = new int[N];
                for (int i = 0; i < populations.Length; i++)
                {
                ...
                performanceFreeMeetingsTestCases.Add(new ElectionCampaignTestCase(15 * TIME_MULTIPLIER, null, description, cities,
                    populations, meetingCosts: new double[N], budget: 25, capitalCity: 0, bestCampaignPeopleMet: 37890, bestCampaignCost: 23));
                performanceMeetingsWithCostsTestCases.Add(new ElectionCampaignTestCase(50 * TIME_MULTIPLIER, null, description, cities,
                    populations, meetingCosts, budget: 25, capitalCity: 0, bestCampaignPeopleMet: 13025, bestCampaignCost: 24));
            }

            {
                ...
                var rng = new Random(2650);
                var N = 500;
                var cities = rgg.UndirectedGraph(typeof(AdjacencyMatrixGraph), N, 0.3, 5, 20, true);
                var meetingCosts = new double[N];
                var populations = new int[N];
                for (int i = 0; i < populations.Length; i++)
                {
                ...
                performanceFreeMeetingsTestCases.Add(new ElectionCampaignTestCase(60 * TIME_MULTIPLIER, null, description, cities,
                    populations, meetingCosts: new double[N], budget: 22, capitalCity: 0, bestCampaignPeopleMet: 15648, bestCampaignCost: 22));
                performanceMeetingsWithCostsTestCases.Add(new ElectionCampaignTestCase(60 * TIME_MULTIPLIER, null, description, cities,
                    populations, meetingCosts, budget: 22, capitalCity: 0, bestCampaignPeopleMet: 4976, bestCampaignCost: 19));
            }

            {
                ...
                var N = 60;
                var cities = rgg.UndirectedGraph(typeof(AdjacencyMatrixGraph), N, 0.5, 5, 20, true);
                var meetingCosts = new double[N];
                var populations = new int[N];
                for (int i = 0; i < populations.Length; i++)
                {
                ...
                performanceFreeMeetingsTestCases.Add(new ElectionCampaignTestCase(50 * TIME_MULTIPLIER, null, description, cities,
                    populations, meetingCosts: new double[N], budget: 42, capitalCity: 0, bestCampaignPeopleMet: 26624, bestCampaignCost: 42));
                performanceMeetingsWithCostsTestCases.Add(new ElectionCampaignTestCase(60 * TIME_MULTIPLIER, null, description, cities,
                    populations, meetingCosts, budget: 42, capitalCity: 0, bestCampaignPeopleMet: 9086, bestCampaignCost: 38));
            }

            {
                ...
                var rng = new Random(2650);
                var N = 4000;
                var cities = rgg.UndirectedCycle(typeof(AdjacencyListsGraph<SimpleAdjacencyList>), N, 1, 1);
                var populations = new int[N];
                for (int i = 0; i < populations.Length; i++)
                {
